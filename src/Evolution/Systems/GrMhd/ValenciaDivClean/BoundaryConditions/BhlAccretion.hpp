 ...
 *
 */
class BhlAccretion final : public BoundaryCondition {
 private:
 ...
 public:
  ...
  static constexpr Options::String help{"BHL accretion boundary condition "};

  BhlAccretion() = default;
  BhlAccretion(BhlAccretion&&) = default;
  BhlAccretion& operator=(BhlAccretion&&) = default;
  BhlAccretion(const BhlAccretion&);
  BhlAccretion& operator=(const BhlAccretion&);
  ~BhlAccretion() override = default;

  explicit BhlAccretion(CkMigrateMessage* msg);

  explicit BhlAccretion(std::unique_ptr<evolution::initial_data::InitialData>
                            analytic_prescription);

  WRAPPED_PUPable_decl_base_template(
      domain::BoundaryConditions::BoundaryCondition, BhlAccretion);
  ...
  using dg_interior_temporary_tags =
      tmpl::list<domain::Tags::Coordinates<3, Frame::Inertial>, Shift, Lapse,
                 InvSpatialMetric>;
  ...
  using fd_interior_temporary_tags =
      tmpl::list<domain::Tags::Coordinates<3, Frame::Inertial>,
                 evolution::dg::subcell::Tags::Mesh<3>, Shift, Lapse,
                 SpatialMetric>;
