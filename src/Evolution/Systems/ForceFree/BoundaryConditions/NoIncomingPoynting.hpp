 ...
 *
 */
class NoIncomingPoynting final : public BoundaryCondition {
 private:
 ...
 public:
  ...
  static constexpr Options::String help{
      "NoIncomingPoynting boundary conditions."};

  NoIncomingPoynting() = default;
  NoIncomingPoynting(NoIncomingPoynting&&) = default;
  NoIncomingPoynting& operator=(NoIncomingPoynting&&) = default;
  NoIncomingPoynting(const NoIncomingPoynting&) = default;
  NoIncomingPoynting& operator=(const NoIncomingPoynting&) = default;
  ~NoIncomingPoynting() override = default;

  explicit NoIncomingPoynting(CkMigrateMessage* msg);

  WRAPPED_PUPable_decl_base_template(
      domain::BoundaryConditions::BoundaryCondition, NoIncomingPoynting);
