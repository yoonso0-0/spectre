 ...
 *
 */
class Reflecting final : public BoundaryCondition {
 private:
 ...
 public:
  ...
  Reflecting& operator=(Reflecting&&) = default;
  Reflecting(const Reflecting&) = default;
  Reflecting& operator=(const Reflecting&) = default;
  ~Reflecting() override = default;

  explicit Reflecting(CkMigrateMessage* msg);

  WRAPPED_PUPable_decl_base_template(
      domain::BoundaryConditions::BoundaryCondition, Reflecting);
