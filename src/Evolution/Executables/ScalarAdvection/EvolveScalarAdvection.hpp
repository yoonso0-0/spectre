...
#include "Evolution/Systems/ScalarAdvection/Initialize.hpp"
...
#include "PointwiseFunctions/AnalyticData/ScalarAdvection/Sinusoid.hpp"  // IWYU pragma: keep
...
struct EvolutionMetavars {
  ...
  using initialization_actions = tmpl::list<
      ...
      ScalarAdvection::Actions::InitializeVelocityField<volume_dim>,
      tmpl::conditional_t<
          evolution::is_analytic_solution_v<initial_data>,
  ...
  static constexpr Options::String help{
      "Evolve the ScalarAdvection equation.\n\n"
      "The analytic solution is: Sinusoid\n"
