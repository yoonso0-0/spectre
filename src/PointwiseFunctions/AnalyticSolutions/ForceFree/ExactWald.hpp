...
/*!
 * \brief An exact solution of Maxwell's equations in the Kerr spacetime found
 * by Wald \cite Wald1974.
 *
 ...
 * \end{equation}
 *
 * We skip the derivation and write out the results below:
 *  \begin{equation}
 ...
 *
 * \note Inside the horizon this solution is no longer force-free; the
 * condition $E_iB^i = 0$ is still satisfied, but $B^2 > E^2$ is not.
 *
 * The violation of a force-free condition $B^2 > E^2$ inside the horizon
 * gives rise to parallel electric current.
 *
 */
class ExactWald : public evolution::initial_data::InitialData,
 ...
 public:
  ...
  static constexpr Options::String help{
      "Exact vacuum solution of Maxwell's equations in a Kerr BH spacetime by "
      "Wald (1974)."};
