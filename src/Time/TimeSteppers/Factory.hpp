...
// We don't include Rk3PareschiSsp4 because it is terribly inefficient
// as an explicit time stepper with 2/5 RHS evaluations ignored.  (One
// is also ignored in IMEX.)
...
using imex_time_steppers =
    tmpl::list<TimeSteppers::Heun2, TimeSteppers::Rk3Kennedy,
               TimeSteppers::Rk3PareschiSsp4, TimeSteppers::Rk4Kennedy>;
}  // namespace TimeSteppers
