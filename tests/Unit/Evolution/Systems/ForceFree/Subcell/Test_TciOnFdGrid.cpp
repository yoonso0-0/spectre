...
void test(const TestThis test_this, const int expected_tci_status) {
  ...
  auto box = db::create<db::AddSimpleTags<
      ...
      ForceFree::Tags::NsInteriorMask,
      domain::Tags::Coordinates<3, Frame::Inertial>, ::domain::Tags::Mesh<3>,
      ::evolution::dg::subcell::Tags::Mesh<3>,
      ForceFree::subcell::Tags::TciOptions,
      evolution::dg::subcell::Tags::SubcellOptions<3>,
      evolution::dg::subcell::Tags::DataForRdmpTci>>(
      subcell_vars, ns_interior_mask, dg_inertial_coords, dg_mesh, subcell_mesh,
      tci_options, subcell_options, evolution::dg::subcell::RdmpTciData{});
