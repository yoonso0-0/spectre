...
void check_implicit_tableau(
  ...
  // Zeroth-order is not useful, and it is impossible to exceed
  // second-order with a DIRK method.
  CHECK((expected_stage_order == 1 or expected_stage_order == 2));
