...
void test_sector(
    const double stencil_size, const double tolerance,
    const Variables<typename Sector::tensors>& explicit_values,
    tuples::tagged_tuple_from_typelist<typename Sector::tags_from_evolution>
        evolution_data) {
  static_assert(
  ...
  using read_only_tags_from_evolution_source =
      tmpl::transform<typename Sector::tags_from_evolution,
  ...
  using simple_tags = tmpl::append<
      read_only_tags_from_evolution_source, typename Sector::simple_tags,
